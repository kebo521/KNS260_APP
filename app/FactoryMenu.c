...
//	TRACE("pInMsg[%s]\r\n",pInMsg);
	...
	TRACE("====分层JSON多次处理(旧)======\r\n");
	{
		...
		if(pFtable)
		{
			char *phead,*pScontent;
			ArrayStringIdGroup(pFtable);
