...
extern void API_GUI_LoadWindow(GuiWindow *pWindow,int contLine);
extern GuiWindow *API_GUI_GetCurrWindow(void);
...
extern void APP_GUI_ShowSysEn(u8 Line,int type,char *pMsgEn); 
