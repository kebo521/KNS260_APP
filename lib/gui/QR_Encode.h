...
extern "C" {
	...
	--<OEM Size>--
	#define MAX_ALLCODEu16		3706			// 憤僐乕僪儚乕僪悢嵟戝抣
	#define MAX_DATACODEu16	2956			// 僨乕僞僐乕僪儚乕僪嵟戝抣(僶乕僕儑儞40-L)
    ...
    typedef struct
    {
		...
		u8 		byDataCodeu32[MAX_DATACODEu16];	// 擖椡僨乕僞僄儞僐乕僪僄儕傾
		...
		u8 		byAllCodeWord[MAX_ALLCODEu16];		// 憤僐乕僪儚乕僪嶼弌僄儕傾
